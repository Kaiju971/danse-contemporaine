...
// import { Spotlight } from "../Spotlight"; // 🟢 Import du nouveau spot SVG
// import {
//   Container,
//   Typography,
//   Box,
...
//                     <Spotlight
//                       style={{
//                         x: "-50%", // Centre le projecteur (grâce à left: "50%" dans le SVG)
//                         rotate: `${tilt}deg`,
//                         transformOrigin: "150px 20px", // 🟢 Le projecteur pivote physiquement autour de sa lentille !
//                       }}
...
import { StageRig } from "./StageRig"; // 🟢 Import de la rampe de 6 spots
import {
  Container,
  Typography,
  Box,
...
export const Teachers = () => {
  ...
  return (
    <TeachersContainer id="teachers">
      ...
      >
        {/* 🟢 RAMPE DE 6 PROJECTEURS FIXES EN HAUT */}
        <StageRig
          activeTeacherId={hoveredTeacher}
